...
<x-dashboard>
    <x-slot:title>Dashboard Product Update</x-slot:title>
        ...
        <form action="{{ route('dashboard-products-update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-12">
                <div class="pb-1">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="description" name="description" rows="3"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm/6">{{ old('description', $product->description) }}</textarea>
                            </div>
                                ...
                                <div class="w-1/2">
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="price" id="price"
                                            class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
                                            placeholder="1.000.000" value="{{ old('price', $product->price) }}">
                                    </div>
                                    @error('price')
                                        <div class="text-sm font-light text-red-500">
                                            <p class="text-sm font-light">{{ $message }}</p>
                    ...
                    <div x-data="fileUploader('{{ $product->image ? asset('storage/' . $product->image) : '' }}')" class="col-span-full">
                        <label for="image" class="block text-sm/6 font-medium text-gray-900">Photo Product</label>
                        <div
