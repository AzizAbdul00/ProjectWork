...
<head>
    ...
    <title>{{ $product->name }} - Cabang Purwakarta</title>
</head>
...
<body class="bg-white">
    ...
    {{-- <div>
        <div class="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:pb-24 lg:max-w-7xl lg:px-8">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Gitar {{ $product->name }}</h2>
    ...
    <div>
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            <!-- Header -->
            <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-6">{{ $product->name }}</h1>
            <!-- Main Section -->
            <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-12 lg:gap-x-8">
                <!-- Product Image -->
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <ul class="list-disc pl-5 text-gray-700 mt-2 space-y-1">
                                <li>Kategori: Gitar {{ $product->category->name ?? 'Tidak ada' }}</li>
                        ...
                        <div class="flex space-x-4 mt-6">
                            <button
                                class="w-full flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-white font-medium hover:bg-indigo-700 sm:w-auto">
                                <i class="ri-shopping-cart-2-line"></i>
                            </button>
                            <a href="https://wa.me/6282125302005?text=*Pesen-barang*"
                                class="w-full flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 font-medium hover:bg-gray-50 sm:w-auto">
                                Beli Sekarang
                            </a>
                        </div>
                    </div>
            ...
            {{-- <div class="mt-12">
                ...
                <div class="mt-6 grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
                    @foreach ($relatedProducts as $related)
                        <div class="group">
                            <div class="aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-gray-100">
                                <a href="#">
                                    <img src="aaa" alt="aasasas"
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <p class="mt-1 text-sm font-medium text-gray-900">Rp. 100000</p>
                            </div>
                        </div>
                    @endforeach
                </div>
